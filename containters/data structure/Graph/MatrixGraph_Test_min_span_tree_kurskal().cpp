...
int main(){
	int min_span;
	char v[]={'a','b','c','d','e','f'};
	MatrixGraph<char> lg1(sizeof(v)/sizeof(*v),v);//构造无向图
	...
	min_span =  lg1.min_span_tree_kurskal();//构造最小生成树并返回最小代价
	cout<<"min_span: "<<min_span<<endl<<endl;
	
	MatrixGraph<char> lg2(sizeof(v)/sizeof(*v),v);//构造无向图
	...
	min_span = lg2.min_span_tree_kurskal();//构造最小生成树并返回最小代价
	cout<<"min_span: "<<min_span<<endl<<endl;
	
	char v2[]={'a','b','c','d','e','f','g'};
	MatrixGraph<char> lg3(sizeof(v2)/sizeof(*v2),v2);//构造无向图
	...
	min_span = lg3.min_span_tree_kurskal();//构造最小生成树并返回最小代价 
	cout<<"min_span: "<<min_span<<endl<<endl;
